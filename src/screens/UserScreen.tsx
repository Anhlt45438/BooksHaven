        ...
        <View style={styles.screen}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerRightContainer}>
                    ...
                    <TouchableOpacity style={styles.headerIcon} onPress={() => navigation.navigate('ManGioHang')}>
                        <Image
            ...
            <ScrollView style={styles.scrollContainer}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.listItem} onPress={() => navigation.navigate('GuiTinNhanChoAdmin')}>
