            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate(
                  ...
                  {
                    field: 'username',
                    currentValue: userDangNhap.username || '',
                  } as never,
                )
              }>
              ...
              <View style={styles.infoRight}>
                <Text
                  style={[
                    styles.infoText,
                    !userDangNhap.username && {color: 'red'},
                  ]}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate(
                  ...
                  {
                    field: 'email',
                    currentValue: userDangNhap.email || '',
                  } as never,
                )
              }>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate(
                  ...
                  {
                    field: 'dia_chi',
                    currentValue: userDangNhap.dia_chi || '',
                  } as never,
                )
              }>
              ...
              <View style={styles.infoRight}>
                <Text
                  style={[
                    styles.infoText,
                    !userDangNhap.dia_chi && {color: 'red'},
                  ]}>
