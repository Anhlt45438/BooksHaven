...
function user() {
    ...
    window.location.replace("/admin-site");  // Changed from window.location.href to window.location.replace
}

function product() {
    console.log("📦 Điều hướng đến trang Sản phẩm...");
    window.location.replace("/admin-site/products");  // Changed from window.location.href to window.location.replace
}
...
function announcement() {
    ...
    window.location.replace("/admin-site/announcements");  // Changed from window.location.href to window.location.replace
}

function reports() {
    console.log("📈 Điều hướng đến trang Báo cáo...");
    window.location.replace("/admin-site/reports");  // Changed from window.location.href to window.location.replace
}

function sendAnnouncement() {
    console.log("📧 Điều hướng đến trang Gửi thông báo...");
    window.location.replace("/admin-site/send-announcement");  // Changed from window.location.href to window.location.replace
}

function productApproval() {
    console.log("📝 Điều hướng đến trang Duyệt sản phẩm...");
    window.location.replace("/admin-site/product-approval");  // Changed from window.location.href to window.location.replace
}