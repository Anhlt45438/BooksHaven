...
import { Rating } from "~/models/schemas/rating/Rating.schemas";

const uri = `mongodb+srv://admin:${encodeURIComponent("Daocongkha2004@")}@cluster0.tta3gjk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
class dataBaseServices {
  ...
  get ratings (): Collection<Rating>{
    return this.db_users.collection(
      process.env.DB_STORYS_COLLECTION_RATINGS_USER || "",
    );
  }
